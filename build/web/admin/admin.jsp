...
<%@ page import="java.util.Locale"
 ...
 %>
  ...
  <%
        ...
        String sql="select user_id, user_name from hr_users where user_id>1";
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a  href="../registration/logout.jsp">Log Out</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
  ...
  <tbody>
    <tr>
      ...
      <td><%= rst.getString("user_name")%></td>
       <form action="../operations/del_user.jsp" method="post"> <td><button type="submit" value="<%= rst.getString("user_id")%>" name="user_id" class="btn btn-primary" style="border-radius: 8px;"  >Delete</button></td> </form>
    </tr>
  </tbody>
          <%
                      }
